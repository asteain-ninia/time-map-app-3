 ...
 *
 * §2.4.4: 自動配色の考え方
 * - 共有境界を持つ面が同色にならないように色を割り当てる
 *   (Phase 2-D-5 以前は「同一レイヤー内」が単位だったが、Phase 2-D-5 で地図全体
 *    1 回算出へ移行。Phase 6 で「同 depth 兄弟」単位へ再設計予定。要件定義書
 *    §2.4.4.3 / 開発ガイド §6.6.6 は旧モデル前提のまま残置で、Phase 6 着手時に改訂)
